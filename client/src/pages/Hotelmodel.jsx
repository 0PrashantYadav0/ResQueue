...
function Hotelmodel() {
  ...
  const styleForButton = count>0? "bg-green-400 text-white" : "bg-gray-200 text-gray-400"
    ...
    <div>
      ...
      <div className="bg-white rounded-t-3xl left-0 w-full relative -top-[200px]">
        ...
        <div>
          ...
          <div>
            <p className="p-6 text-sm">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eos explicabo tempora nam consectetur quisquam animi eius, voluptate unde maxime odio ex magni id nostrum sed nobis porro similique quae? Molestias!</p>
          </div>
        </div>
        ...
        <div className="md:flex md:m-6">  
          ...
          <div className="mx-6 md:w-1/3">
            <button className={`w-full  rounded-xl py-4 ${styleForButton}`} onClick={redirectToReservation}>
              Check Reservations
            </button>
          </div>
        </div>
